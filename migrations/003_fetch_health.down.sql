-- 003_fetch_health.down.sql
-- Reverse of 003: drop the fetch-health-aware eligibility view + health view and
-- restore the original (001) v_patient_eligibility verbatim.
DROP VIEW IF EXISTS v_patient_eligibility;
DROP VIEW IF EXISTS v_patient_fetch_health;
